...
class game:
    def __init__(self,root):
        ...
        def cm_corner():
            ...
            lab1.config(text='1')
            lab1.place(x=1000,y=200)
            lab2.config(text='2')
            lab2.place(x=1078,y=200)
            lab3.config(text='3')
            lab3.place(x=1149,y=200)
            lab4.config(text='4')
            lab4.place(x=1000,y=250)
            lab5.config(text='5')
            lab5.place(x=1078,y=250)
            lab6.config(text='6')
            lab6.place(x=1149,y=250)
            lab7.config(text='7')
            lab7.place(x=1000,y=300)
            lab8.config(text='8')
            lab8.place(x=1078,y=300)
            lab9.config(text='9')
            lab9.place(x=1149,y=300)
